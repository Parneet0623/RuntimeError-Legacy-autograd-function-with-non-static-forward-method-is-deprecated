...
import torch #very efficient for NNs
from torch.autograd import Variable # for gradient(converting tensors in torch variables)
import cv2 #for drawing rectangles(not using its models)
